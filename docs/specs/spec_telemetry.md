...
10. (optional) `INSTANCES: <n>` followed by one or more indented lines containing base64 blobs for each currently alive spawned kernel.  This is only present if the application has recorded instance activity during the run.
